  ...
  return (
    ...
    <a className="mt-5 flex ml-1.5 text-[#3D4098] text-lg" href="https://www.tiktok.com/@icttaxation?lang=en"><FaTiktok /></a> 
          ...
          <div className="flex gap-10">
            <img className="h-96 w-72 object-cover rounded-xl" src="34.png" alt="ICT Feature" />
            <div className="hidden lg:block">
              <img className="h-44 w-72 -ml-8 mt-14 object-cover rounded-xl" src="36.png" alt="ICT Detail" />
              <img className="h-44 w-72 -ml-8 mt-4 object-cover rounded-xl" src="37.png" alt="ICT Detail" />
            </div>
          </div>
        </div>
      </div>
