  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-6 font-sans">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-1 h-full">
          <div className="sticky top-24 flex flex-col items-center gap-4 py-6">
            ...
            <a href={shareLinks.facebook} target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-600 text-white rounded-full hover:scale-110 transition shadow-md">
              <FaFacebookF />
            </a>

            <a href={shareLinks.twitter} target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-400 text-white rounded-full hover:scale-110 transition shadow-md">
              <FaTwitter />
            </a>

            <a href={shareLinks.linkedin} target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-700 text-white rounded-full hover:scale-110 transition shadow-md">
              <FaLinkedinIn />
            </a>

            <a href={shareLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="p-3 bg-[#25D366] text-white rounded-full hover:scale-110 transition shadow-md">
              <FaWhatsapp />
            </a>
        ...
        <aside className="lg:col-span-4 space-y-12">
          ...
          <form action="/blogs" method="GET" className="flex items-stretch shadow-sm">
            ...
            <input
              ...
              name="search"
              placeholder="Search..."
              className="w-full bg-gray-100 px-4 py-3 rounded-l-md outline-none focus:ring-1 focus:ring-green-500"
            />

            <button type="submit" className="bg-[#22c55e] text-white px-5 rounded-r-md hover:bg-black transition">
              <IoSearch size={20} />
            </button>
              ...
              {latestPosts?.slice(0, 10).map((post: any) => (
                ...
                <Link key={post._id} href={`/blogs/${post.slug}`} className="flex gap-4 group items-center">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <h4 className="text-sm font-bold text-gray-900 group-hover:text-[#22c55e] line-clamp-2">
                      {post.title}
                    </h4>
          ...
          <div>
            ...
            <div className="grid gap-6">
              ...
              {courses?.slice(0, 5).map((course: any) => (
                ...
                <div key={course._id} className="bg-white rounded-xl shadow-sm overflow-hidden border group">
                  ...
                  <div className="p-4">
                    ...
                    <h4 className="font-bold text-sm mb-3 line-clamp-1 group-hover:text-[#22c55e]">
                      {course.title}
                    </h4>

                    <Link
                      href={`/courses/${course.slug.current}`}
                      className="block text-center bg-[#3D4098] text-white text-xs font-bold py-2 rounded-lg hover:bg-[#22c55e]"
                    >
                      Explore Course
                    </Link>
          ...
          <div className="bg-[#f0fdf4] border border-[#22c55e]/30 rounded-2xl p-6 text-center space-y-4">
            ...
            <a
              ...
              className="inline-block w-full py-2 bg-white border-2 border-[#22c55e] text-[#22c55e] font-bold rounded-lg hover:bg-[#22c55e] hover:text-white transition"
            >
      ...
      <a
        ...
        className="fixed bottom-8 right-8 z-[100] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition flex items-center justify-center w-14 h-14"
      >
        <FaWhatsapp size={32} />
      </a>
