...
type Step = "name" | "phone" | "email" | "program" | "reason" | "success";
...
export default function LeadForm({ courses }: { courses: Course[] }) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      } else if (step !== "program" && step !== "success") {
  ...
  const steps: Step[] = ["name", "phone", "email", "program", "reason"];
  ...
  const nextStep = () => {
    ...
    const stepOrder: Step[] = ["name", "phone", "email", "program", "reason", "success"];
